        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <AnimateOnScroll>
            <div className="space-y-6">
              ...
              <div className="p-6 bg-white rounded-2xl border border-dark/5 shadow-sm flex items-start gap-4">
          ...
          <AnimateOnScroll delay={0.2}>
            <div className="bg-white p-8 rounded-3xl border border-dark/5 shadow-xl shadow-dark/5">
