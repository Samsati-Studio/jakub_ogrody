    ...
    >
          ...
          <div className="hidden items-center gap-10 md:flex">
            {NAV_LINKS.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className={`text-sm md:text-md lg:text-base font-medium transition-colors hover:text-accent ${
            ...
            <ContactButton className="text-sm px-4 py-1.5" />
          </div>
      ...
      {isMobileOpen && (
        <div className="fixed inset-0 top-16 z-40 bg-white md:hidden">
          <div className="flex flex-col items-center gap-8 px-4 pt-8">
            {NAV_LINKS.map((link) => (
              <a
                key={link.href}
                href={link.href}
